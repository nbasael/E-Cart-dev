				...
				<Card.Body className="m-sm-3 m-md-5">
					...
					<Row className="mb-4">
						<Col md="6">
							...
							<p>
								4183 Forest Avenue <br /> New York City <br />{' '}
								10011 <br /> USA <br />
								<a href="mailto:chris.wood@gmail.com">
						...
						<Col md="6" className="text-md-right">
							...
							<p>
								354 Roy Alley <br /> Denver <br /> 80202 <br />{' '}
								USA <br />
								<a href="mailto:info@appstack.com">
									info@appstack.com
								</a>
							</p>
						</Col>
					...
					<div className="text-center">
						<p className="text-sm">
							<strong>Extra note:</strong> Please send all items
							at the same time to the shipping address. Thanks in
							advance.
						</p>
