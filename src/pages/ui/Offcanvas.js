		...
		<Card>
			<Card.Header>
				...
				<h6 className="card-subtitle text-muted">
					Build hidden sidebars into your project for navigation,
					shopping carts, and more with a few classes and our
					JavaScript plugin.
				</h6>
			</Card.Header>
	...
	<Card>
		<Card.Header>
			...
			<h6 className="card-subtitle text-muted">
				...
				must set the <code>placement</code> parameter.
			</h6>
		</Card.Header>
		<Card.Body className="text-center">
	...
	<Card>
		<Card.Header>
			...
			<h6 className="card-subtitle text-muted">
				...
				<code>scroll</code> parameter to toggle{' '}
