				...
				<Col lg="5" className="mx-auto">
					...
					<div className="my-4">
						<OverlayTrigger
							placement="bottom"
							overlay={
								<Tooltip>Available for JavaScript</Tooltip>
							}
						>
							<img
								width="40"
						...
						<OverlayTrigger
							placement="bottom"
							overlay={
								<Tooltip>Available for TypeScript</Tooltip>
							}
						>
							<img
								width="40"
					...
					<p className="text-lg">
						A professional package that comes with hundreds of UI
						components, forms, tables, charts, dashboards, pages and
						svg icons.
					</p>
						...
						<div className="col-lg-10 col-xl-9 mx-auto">
							<div className="mb-4">
								...
								<p className="text-muted fs-lg">
									4 Pre-built color schemes and multiple
									layout types are available to make this
									template your very own. All the color
									schemes can take variation in color and
									styling, that can easily be modified using
									Sass variables.
								</p>
							</div>
						</div>
			...
			<Row>
				<Col md="10" className="mx-auto text-center">
					<div className="mb-5">
						...
						<p className="text-muted fs-lg">
							AppStack React includes multiple ready-to-deploy
							integrations, including Redux, ESLint, Prettier,
						...
						<div className="my-4">
							...
							<OverlayTrigger
								placement="bottom"
								overlay={
									<Tooltip>Firebase Authentication</Tooltip>
								}
							>
								<div className="landing-integration">
									<img
	...
	<section className="py-6">
		<Container>
			<div className="mb-5 text-center">
				...
				<p className="text-muted fs-lg">
					Here's what some of our 5,000+ customers have to say about
					...
					<Card as="blockquote" className="landing-quote border">
						<Card.Body className="p-4">
							...
							<p className="lead mb-2">
								“We are totally amazed with a simplicity and the
								design of the template.{' '}
								<span>
									Probably saved us hundreds of hours of
									development.
								</span>{' '}
								We are absolutely amazed with the support
								Bootlab has provided us.”
							</p>
					...
					<Card as="blockquote" className="landing-quote border">
						<Card.Body className="p-4">
							...
							<p className="lead mb-2">
								...
								<span>
									any new additions I'd make would feel like a
									native extension of the theme
								</span>{' '}
								versus a simple hack. I definitely feel like
								this will save me hundredths of hours I'd
								otherwise spend on designing.”
							</p>
				...
				<Col md="6" lg="4" className="d-block d-md-none d-lg-block">
					<Card as="blockquote" className="landing-quote border">
						<Card.Body className="p-4">
							...
							<p className="lead mb-2">
								“I ran into a problem and contacted support.
								Within 24 hours, I not only received a response
								but even an updated version that solved my
					...
					<Row>
						<div className="col-lg-10 col-xl-9 mx-auto">
							<div className="mb-4">
								...
								<p className="text-muted fs-lg">
									5 Dashboards and 40+ Pages featuring various
									components, giving you the freedom of
									choosing and combining. All components can
									take variation in color and styling, that
									can easily be modified using Sass.
								</p>
							</div>
						</div>
					</Row>
				...
				<Col md="10" className="mx-auto text-center">
					<div className="mb-5">
						...
						<p className="text-muted text-lg">
							A responsive dashboard built for everyone who wants
							to create webapps on top of Bootstrap &amp; React.
						</p>
					</div>
							...
							<div className="d-flex py-3">
								...
								<div className="flex-grow-1">
									...
									<p className="fs-lg">
										...
										customize our themes. Our code is very
							...
							<div className="d-flex py-3">
								...
								<div className="flex-grow-1">
									...
									<p className="fs-lg">
										...
										AdminKit is responsive in all browsers.
									</p>
								</div>
							</div>
						</Col>
						<Col md="6">
							<div className="d-flex py-3">
								...
								<div className="flex-grow-1">
									...
									<p className="fs-lg">
										Our themes are supported by specialists
										who provide quick and effective support.
										Usually an email reply takes &lt;24h.
									</p>
								</div>
							</div>
						</Col>
						<Col md="6">
							<div className="d-flex py-3">
								...
								<div className="flex-grow-1">
									...
									<p className="fs-lg">
										The package comes with fully working
										authentication examples, including
										Firebase, Auth0, AWS Cognito and JWT.
									</p>
								</div>
							</div>
						</Col>
						<Col md="6">
							<div className="d-flex py-3">
								...
								<div className="flex-grow-1">
									...
									<p className="fs-lg">
										We strictly follow Bootstrap's
										guidelines to make your integration as
										easy as possible. All code is
										handwritten.
									</p>
								</div>
							</div>
						...
						<Col md="6">
							<div className="d-flex py-3">
								...
								<div className="flex-grow-1">
									...
									<p className="fs-lg">
										From time to time you'll receive an
										update containing new components,
						...
						<Accordion activeKey={activeKey}>
							<Card className="border mb-3">
								...
								<Accordion.Collapse eventKey="0">
									<Card.Body className="py-3">
										Yes, the package includes two projects,
										based on JavaScript &amp; TypeScript.
										Both projects are fully-featured, and
										contain all components, icons, pages,
										auth types and more.
									</Card.Body>
								</Accordion.Collapse>
							</Card>
							<Card className="border mb-3">
								...
								<Accordion.Collapse eventKey="1">
									<Card.Body className="py-3">
										You have access to the Software's online
										support services via email for six (6)
										months from the purchase date. Please
										contact us at{' '}
										<a href="mailto:support@bootlab.io">
											support@bootlab.io
										</a>{' '}
										for any questions.
									</Card.Body>
							...
							<Card className="border mb-3">
								...
								<Accordion.Collapse eventKey="2">
									<Card.Body className="py-3">
										You'll receive an email from Bootstrap
										themes once your purchase is complete.
							...
							<Card className="border mb-3">
								...
								<Accordion.Collapse eventKey="3">
									<Card.Body className="py-3">
										You can purchase the themes on Bootstrap
										Themes via any major credit/debit card
										(via Stripe) or with your Paypal
										account. We don't support
										cryptocurrencies or invoicing at this
										time.
									</Card.Body>
								</Accordion.Collapse>
							</Card>
							<Card className="border mb-3">
								...
								<Accordion.Collapse eventKey="4">
									<Card.Body className="py-3">
										Yes, AppStack React has been thoroughly
										tested with npm and yarn (LTS versions).
									</Card.Body>
								</Accordion.Collapse>
							</Card>
						</Accordion>
		...
		<Container className="text-center landing-footer-container">
			<Row>
				<Col md="9" lg="8" xl="6" className="mx-auto">
					<h2 className="h1 mb-3">
						Join over 5,000 developers who are already working with
						our products
					</h2>
					<Button
						variant="success"
