...
const Intro = () => (
	<div className="mb-5">
		<h3>Introduction</h3>
		<p className="text-lg">
			<code>npm run build</code> creates a build directory with a
			production build of your app. Set up your favorite HTTP server so
			that a visitor to your site is served index.html, and requests to
			static paths like <code>{`/static/js/main.<hash>.js`}</code> are
			served with the contents of the{' '}
...
serve -s build`}</Code>
		...
		<p className="text-lg">
			...
			<code>-l</code> or <code>--listen</code> flags:
		</p>
...
const OtherSolutions = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			React App project in production. It also works well when integrated
			into an existing server side app.
		</p>
	</div>
);
...
const Express = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			Node.js. Here’s a programmatic example:
		</p>
...
netlify deploy`}</Code>
		...
		<p className="text-lg">
			...
			<br />
			With this setup Netlify will build and deploy when you push to git
