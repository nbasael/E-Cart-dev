...
const Intro = () => (
	<div className="mb-5">
		<h3>Introduction</h3>
		<p className="text-lg">
			AppStack React is built using Create Rect App. Follow the steps
			below to migrate to Next.js Migrating to Next.js allows you to use
			SSR, API Routes and more.
		</p>
	</div>
);
...
const OfficialGuide = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			The official guide on how to migrate from Create React App to
			Next.js can be found{' '}
			<a
...
const UpdateDependencies = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			Remove the <code>react-scripts</code> and{' '}
...
const UpdateSharedLayout = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			Create React App uses the <code>/src/index.js</code> file as an
			entry point, whereas Next.js requires a custom{' '}
			<code>/src/_app.js</code> file. You may want to move logic to the
			new <code>_app.js</code> file. Learn more{' '}
			<a
...
const UpdateRoutes = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			using a third-party library, Next.js includes its own file-system
			based routing.
		</p>
		<ul className="text-lg">
			<li>
				Convert all Route components to new files in the{' '}
				<code>src/pages</code> directory. It is recommended to rename
			...
			<li>
				Replace the Link component from <code>react-router-dom</code>{' '}
				with the Link component from <code>next/link</code>.
			</li>
		</ul>
		<p className="text-lg">
