...
const Intro = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			crafted on top of Bootstrap 5 and React. The included docs don't
...
const TableOfContents = () => (
	<div className="mb-5">
		...
		<ul className="text-lg">
			...
			<li>
				<Link to="/docs/environment-variables">
			...
			<li>
				<Link to="/docs/internationalization">
			...
			<li>
				<Link to="/docs/migrating-to-next-js">
...
const SomethingMissing = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			part confusing, please send us an email (
			<a href="mailto:support@bootlab.io">support@bootlab.io</a>) with
