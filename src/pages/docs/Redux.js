...
const Intro = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			, to keep the amount of boilerplate code and complexity to a
			minimum.
		</p>
	</div>
);
...
const Usage = () => (
	<div className="mb-5">
		<h3>Usage</h3>
		<p className="text-lg">
			AppStack contains the following folders/files to store any Redux
			related logic:
		</p>

		<ul className="text-lg">
			<li>
				<code>src/redux/store.js</code> where reducers are combined and
...
const AddSliceToRootReducer = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			Open the <code>/src/redux/store.ts</code> file and add the new
			slice:
		</p>
...
const RealLifeExample = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			<code>createSlice</code> and <code>createAsyncThunk</code>. Any time
			you click the "Increment" and "Decrement buttons in the example
		...
		<ul className="text-lg">
			...
			<li>
				The counter slice reducer will see the actions and update its
				state
			</li>
			<li>
...
const ReduxDevTools = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			workflow or any other architecture which handles the state change
			(see integrations).
		</p>
		<p className="text-lg">
