...
const QuickStart = () => (
	<div className="mb-5">
		...
		<p className="text-lg">
			...
			<a href="https://nodejs.org/en/">Node.js</a> before using Appstack
			React.
		</p>

		<p className="text-lg mb-3">
			Once Node.js is installed, run <code>npm install</code> to install
			the rest of AppStack React's dependencies. All dependencies will be
		...
		<p className="text-lg mb-3">
			...
			webpack-serve to automatically detect file changes and start a local
			webserver at <code>http://localhost:3000</code>.
		</p>
		<Code>npm start</Code>
	</div>
);
